...
export default class VideoPlayer extends Component {
  ...
  showSubtitle() {
    ...
    //console.log(startTime, currentTime, endTime, subtitleIndex);
  ...
  replayVideo = () => {
    ...
    this.setState(state);
    this.hideReplay();
    this.setState({ subtitleIndex: 0, currentTimeInDeciSeconds: 0 });
  };
  renderReplayButton = () => {
    ...
    return (
      ...
      >
        <TouchableHighlight onPress={this.replayVideo}>
          <Icon
            name="replay"
            type="material-community"
            color="white"
